...
module ActiveRecord
  module ConnectionAdapters
    ...
    register "preloadable_postgresql", "ActiveRecord::ConnectionAdapters::PreloadablePostgreSQLAdapter", "active_record/connection_adapters/preloadable_postgresql_adapter"
